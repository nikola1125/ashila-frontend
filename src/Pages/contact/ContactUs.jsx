...
const ContactUs = () => {
  ...
  return (
    <>
      <SEO
        title="Na Kontaktoni | Farmaci Ashila | Këshillim dhe Mbështetje"
        description="Na kontaktoni në Farmaci Ashila për çdo pyetje rreth produkteve tona, shërbimeve ose këshillim farmaceutik. Jemi këtu për t'ju ndihmuar."
        canonicalUrl="https://www.farmaciashila.com/contact-us"
      />
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#2c2c2c]">
                        Cel: +355 68 687 9292
                        <br />
                        Email: ermira.maxhuni@yahoo.com
                      </p>
                    </div>
                  </div>
