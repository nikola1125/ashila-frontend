  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          ref={backdropRef}
          className="fixed inset-0 bg-black/50 z-[9999] transition-opacity animate-in fade-in duration-300"
      ...
      <div 
        ref={sidebarRef}
        data-cart-sidebar
        className={`fixed right-0 top-0 h-screen w-full max-w-md bg-white shadow-2xl z-[10000] flex flex-col transform transition-transform duration-300 ease-in-out overflow-y-auto ${
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-8 h-8 flex items-center justify-center border border-[#D9BFA9] hover:bg-[#EBD8C8] disabled:opacity-50 disabled:cursor-not-allowed transition-all bg-white text-[#4A3628] shrink-0"
                      ...
                      <button
                        ...
                        className="p-1.5 hover:bg-red-50 transition-all flex items-center justify-center shrink-0"
                        aria-label="Remove item"
                      >
                        <Trash2 size={16} className="text-[#4A3628] hover:text-red-600 flex-shrink-0" />
                      </button>
                    </div>
                  </div>
                </div>
