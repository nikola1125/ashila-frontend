    ...
    <footer className="bg-[#F5EDE4] border-t border-[#D9BFA9]">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8 mb-4 md:mb-8">
          ...
          <div className="flex items-center justify-center md:justify-start md:order-4 -mt-8 md:mt-0">
          ...
          {/* Logo and Mission */}
          <div className="col-span-1 md:col-span-2 md:order-1 -mt-4 md:mt-0">
...
{/* Customer Care */}
<div className="md:order-2 mt-0 md:mt-0">
  ...
  <div className="mt-2 flex flex-col space-y-3">
    ...
    <a
      ...
      className="text-sm text-[#A67856] hover:text-[#8B5A3C] underline leading-relaxed px-0 py-1"
    >
      farmaciashila11@gmail.com
    </a>

    {/* Phone */}
    <div className="relative -mt-4" ref={phoneMenuRef}>
      <button
        type="button"
        onClick={() => setPhoneMenuOpen(!phoneMenuOpen)}
        className="text-sm text-[#A67856] hover:text-[#8B5A3C] underline leading-relaxed text-left bg-transparent border-0 px-0 py-1 w-auto"
